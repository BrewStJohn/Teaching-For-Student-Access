...
def attackPokemon(name, myMoves, wildPokemon, enemyMoves):
    '''Handles the Pokemon fighting. Returns false when one of the pokemon 
    has been defeated.'''
    global myHP, enemyHP
    ...
    if speed > 0.5:
        ...
        if enemyHP > 0:
            damage = random.randint(10, 45)
            myHP -= damage
            print("The wild {} retaliates with a {} attack. It does {} damage.".format(
                wildPokemon, enemyMove, damage))
        ...
        if myHP > 0:
            damage = random.randint(10, 45)
            enemyHP -= damage
            print("{} retaliates with a {} attack. It does {} damage.".format(name,
            myMove, damage))
